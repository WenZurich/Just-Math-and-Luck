...
`)}async function ps(t="#xq-root"){const e=()=>typeof t=="string"?document.querySelector(t):t;try{let o=e();if(o||(await new Promise(i=>requestAnimationFrame(i)),o=e()),!o)return console.warn("initStrategies: #xq-root missing"),{ok:!1,error:new Error("xq-root missing")};const n=await rs();return o=e(),o?(cs(o,n),{ok:!0,data:n}):{ok:!1,error:new Error("xq-root gone after fetch")}}catch(o){const n=e();return n&&(n.innerHTML=`<div class="xq-empty"><p>${s(a("strategyLoadError",{msg:o.message}))}</p></div>`),{ok:!1,error:o}}}const oa="./data/research-library.json",ia="./covers/placeholder-book.svg",na="./covers/placeholder-paper.svg",la="./covers/placeholder-podcast.svg",us={candidate:"rl-status-candidate",deferred:"rl-status-deferred",adopted:"rl-status-adopted",rejected:"rl-status-rejected"},gs={yes:"rl-cand-yes",no:"rl-cand-no",watch:"rl-cand-watch"};function hs(t){return{candidate:a("researchStatusCandidate"),deferred:a("researchStatusDeferred"),adopted:a("researchStatusAdopted"),rejected:a("researchStatusRejected")}[t]||t}function ms(t){return{yes:a("researchCandYes"),no:a("researchCandNo"),watch:a("researchCandWatch")}[t]||t}function ys(t){return t==="US"?a("usStock"):t==="TW"?a("twStock"):t==="BOTH"?a("researchMarketBoth"):t}function ra(t){return a(t==="paper"?"researchTypePaper":t==="podcast"?"researchTypePodcast":"researchTypeBook")}function Ce(t,e={}){var i;if(!t)return a("researchShelfAdjacent");const o=(i=e==null?void 0:e.shelfLabels)==null?void 0:i[t];if(o&&typeof o=="object")return Ie(o,t);const n={core_investing:"researchShelfCoreInvesting",value_investing:"researchShelfValueInvesting",business_management:"researchShelfBusiness",life_partner_wisdom:"researchShelfLifePartner",options:"researchShelfOptions",recent_reads:"researchShelfRecentReads",fi_concepts:"researchShelfFiConcepts",money_values:"researchShelfMoneyValues",investing_basics:"researchShelfInvestingBasics",asset_allocation:"researchShelfAssetAllocation",financials:"researchShelfFinancials",market_analysis:"researchShelfMarketAnalysis",econ_analysis:"researchShelfEconAnalysis",psych_randomness:"researchShelfPsych",biographies:"researchShelfBiographies",adjacent:"researchShelfAdjacent"}[t];return n?a(n):t}function fs(t={}){return(Array.isArray(t.shelves)?t.shelves:null)||["core_investing","value_investing","business_management","life_partner_wisdom","options","recent_reads","fi_concepts","money_values","investing_basics","asset_allocation","financials","market_analysis","econ_analysis","psych_randomness","biographies","adjacent"]}function Ie(t,e){if(!t||typeof t!="object")return e;const o=Oe();return t[o]||t.en||t["zh-Hant"]||e}function ca(t){return Ie(t.titleLocalized,t.title)||""}function vs(t){return Ie(t.summaryLocalized,t.summary)||""}function ks(t,e){return t.coverUrl?t.coverUrl:t.cover?t.cover:t.type==="paper"?(e==null?void 0:e.defaultCoverPaper)||na:t.type==="podcast"?(e==null?void 0:e.defaultCoverPodcast)||la:(e==null?void 0:e.defaultCoverBook)||ia}function Ss(t,e){return t.coverFallback?t.coverFallback:t.type==="paper"?(e==null?void 0:e.defaultCoverPaper)||na:t.type==="podcast"?(e==null?void 0:e.defaultCoverPodcast)||la:(e==null?void 0:e.defaultCoverBook)||ia}function bs(t){const e=t==null?void 0:t.plainTakeawaysLocalized;if(e&&typeof e=="object"){const o=Oe(),n=e[o]||e["zh-Hant"]||e.en;if(Array.isArray(n)&&n.length)return n}return Array.isArray(t==null?void 0:t.plainTakeaways)&&t.plainTakeaways.length?t.plainTakeaways:[]}function $s(t){const e=bs(t);return e.length?`<div class="rl-block">
    ...
    <article class="lk-card" data-symbol="${s(o.symbol)}">
      ...
      <section class="lk-block" aria-label="${s(a("lookupQuoteStats"))}">
        ...
        <div class="lk-metrics">
          ...
          ${R(a("lookupMarketCap"),x(jt(o.marketCap,o.currency)))}
      ...
      <section class="lk-block" aria-label="${s(a("lookupFinancials"))}">
        ...
        <div class="lk-metrics">
          ${R(a("lookupRevenue"),x(jt(o.revenue,o.currency)))}
  ...
  `}function Bo(){return`
    ...
    </section>`}async function Do(t="#sx-root"){const e=typeof t=="string"?document.querySelector(t):t;if(!e)return{ok:!1};try{const o=await fetch(xo);if(!o.ok)throw new Error(`HTTP ${o.status}`);const n=await o.json();return zo(e,n),{ok:!0,data:n}}catch(o){return e.innerHTML=`
...
`).toLowerCase().includes(o)):e}function bi(t){const e=ki(t),o=t.ep!=null?`<span class="gy-ep-num">EP${s(String(t.ep))}</span>`:"",n=t.pubDateTw?`<time class="gy-ep-date" datetime="${s(t.pubDateIso||t.pubDateTw)}">${s(t.pubDateTw)}</time>`:"",i=e?`<span class="gy-ep-badge gy-ep-badge-listened">${s(a("gooayeBadgeListened"))}</span>`:`<span class="gy-ep-badge gy-ep-badge-rss">${s(a("gooayeBadgeRssOnly"))}</span>`,l=t.title||(t.ep!=null?`EP${t.ep}`:a("gooayeUntitled"));let r="";if(e){const p=(t.stockAnalysis||[]).filter(Boolean);r+=`<p class="gy-ep-kicker gy-ep-kicker-stock">${s(a("gooayeStockAnalysis"))}</p>`,r+=`<ul class="gy-ep-points gy-ep-stock">${p.map(h=>`<li>${s(h)}</li>`).join("")}</ul>`;const d=(t.rssTeaser||t.keyPoints||[]).filter(Boolean);if(d.length&&(r+=`<details class="gy-ep-rss-details"><summary>${s(a("gooayeRssTeaserToggle"))}</summary>`,r+=`<ul class="gy-ep-points gy-ep-rss">${d.map(h=>`<li>${s(h)}</li>`).join("")}</ul></details>`),t.listenedAt||t.transcriptSource){const h=[];t.listenedAt&&h.push(a("gooayeListenedAt",{date:String(t.listenedAt).slice(0,16).replace("T"," ")})),t.transcriptSource&&h.push(String(t.transcriptSource)),r+=`<p class="gy-ep-source-note">${s(h.join(" · "))}</p>`}}else{const p=(t.keyPoints||[]).filter(Boolean);r+=`<p class="gy-ep-kicker">${s(a("gooayeKeyPoints"))}</p>`,p.length?r+=`<ul class="gy-ep-points">${p.map(h=>`<li>${s(h)}</li>`).join("")}</ul>`:r+=`<p class="gy-ep-empty">${s(a("gooayeNotesThin"))}</p>`;const d=t.notesQuality==="teaser"||t.notesQuality==="title-only"||!p.length?`<p class="gy-ep-source-note">${s(a("gooayeTeaserNote"))}</p>`:`<p class="gy-ep-source-note">${s(a("gooayeRssOnlyNote"))}</p>`;r+=d}const c=t.link?`<a class="gy-ep-link" href="${s(t.link)}" target="_blank" rel="noopener noreferrer">${s(a("gooayeListen"))}</a>`:"";return`
    ...
    </div>`;const d=t.querySelector("[data-gy-search]");if(d){let f=null;d.addEventListener("input",()=>{clearTimeout(f),f=setTimeout(()=>{Ne=d.value||"",Ae=de,je(t,e)},180)})}const h=t.querySelector("[data-gy-more]");h&&h.addEventListener("click",()=>{Ae+=de,je(t,e)})}function $i(){return`
  ...
  `}function fa(t){let e=s(t);return e=e.replace(/漲停/g,m("limitUp",a("limitUp"))),e=e.replace(/動能/g,m("momentum",a("momentum"))),e}function Ut(t){return t.map(e=>{const o=e.rsVsIndexPp??e.priorClosePct,n=e.rsVsIndexPp!=null?N(e.rsVsIndexPp):e.priorClosePct!=null?N(e.priorClosePct):"—";return`
      <tr>
      ...
      </tr>`}).join("")}function Wt(t){return t.map(e=>{const o=e.rsVsIndexPp!=null?`<span class="${H(e.rsVsIndexPp)}">${m("rs","RS")} ${N(e.rsVsIndexPp)}</span>`:e.priorClosePct!=null?`<span class="${H(e.priorClosePct)}">${m("priorClose",a("priorClose"))} ${N(e.priorClosePct)}</span>`:"";return`
      <div class="list-card">
        <div class="lc-head">
          <div>
