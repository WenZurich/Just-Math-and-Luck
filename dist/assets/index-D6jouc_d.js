(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(s){if(s.ep)return;s.ep=!0;const l=a(s);fetch(s.href,l)}})();const j={},R={supabaseUrl:typeof import.meta<"u"&&(j==null?void 0:j.VITE_SUPABASE_URL)||"https://whlpzhceivahkuanmmui.supabase.co",supabaseAnonKey:typeof import.meta<"u"&&(j==null?void 0:j.VITE_SUPABASE_ANON_KEY)||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndobHB6aGNlaXZhaGt1YW5tbXVpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODk0OTE0NDYsImV4cCI6MjEwNTA2NzQ0Nn0.r099L2Eai86nq12Tft0R-QRynz1Dd7UdJHTZ08A1J3Q",giscus:{enabled:!0,repo:"WenZurich/Just-Math-and-Luck-",repoId:"R_kgDOUcO78Q",category:"General",categoryId:"DIC_kwDOUcO78c4DFrWU",mapping:"specific",theme:"dark",lang:"zh-TW",perTicker:!1},socialDigestUrl:"./data/social-digest.json",latestUrl:"./data/latest.json",danmakuMaxLen:80,commentMaxLen:500,pollIntervalMs:8e3,postCooldownMs:4e3};globalThis.STOCK_SOCIAL_CONFIG=Object.assign(globalThis.STOCK_SOCIAL_CONFIG||{},R);const mt={dayPct:{title:"日漲跌",plain:"就是「今天這支股票的價錢，比起昨天收盤時，漲了還是跌了多少」。用百分比表示，比較好跟其他股票比。",example:"昨天收盤 100 元，今天收盤 103 元，日漲跌就是 +3%。像考試分數從 100 變成 103，多了 3 分。"},pct5d:{title:"5 日漲跌",plain:"看最近大約一週（5 個交易日）這支股票總共漲了或跌了多少，不是只看今天。",example:"禮拜一 100 元，到這禮拜五變成 110 元，5 日大約就是 +10%。像一週零用錢從 100 變成 110。"},pct1m:{title:"約 1 月漲跌",plain:"看最近大約一個月（常算 21 個交易日）這支股票漲跌多少，用來看比較長一點的趨勢。",example:"一個月前 200 元，現在 220 元，約 1 月就是 +10%。像身高一個月長高一點，要看整段變化。"},rs:{title:"相對強度（RS）",plain:"把「這支股票今天的漲跌」跟「整個市場大盤今天的漲跌」相減。正的表示它比大盤更強（人家跌它比較不跌，或人家漲它漲更多）。",example:"大盤今天 −1%，某股票 +2%，RS 大約是 +3 個百分點。像全班平均考 60 分，你考 80 分，你比班級平均強。"},priorClose:{title:"前收漲幅",plain:"用「上一個完整交易日收盤價」算出來的漲跌幅度。美股若還在盤中，有時會另外標前一天收盤的表現。",example:"週一收盤比週五收盤漲了 13%，就說前收漲幅約 +13%。像昨天整場比賽的最終比分，不是今天還沒打完的分數。"},volRatio:{title:"量比",plain:"今天成交的「張數／股數」是不是比平常多。算法大概是：今天成交量 ÷ 最近約 20 天平均成交量。數字越大，表示今天很多人在買賣。",example:"平常每天成交 100 萬股，今天 300 萬股，量比約 3 倍。像平常教室很安靜，今天突然擠滿人在討論。"},sma20:{title:"SMA20（20 日均線）",plain:"把最近 20 個交易日的收盤價加起來除以 20，得到一條「平滑後的平均價」。股價在均線上面，常被看成最近偏強；在下面常被看成偏弱。",example:"最近 20 天平均價 50 元，今天股價 55 元，就是站上 SMA20。像你的體重比最近 20 天平均還高一點。"},sma50:{title:"SMA50（50 日均線）",plain:"跟 SMA20 一樣是平均價，但用更長的 50 個交易日，看比較中期的方向。",example:"50 天平均 100 元，現在股價 90 元，就是在 SMA50 下面。像月考平均，比段考平均更能看出一陣子的狀況。"},screenA:{title:"篩選 A（動能／相對強度）",plain:"用數學檢查：這支股票最近是不是漲得比大盤好、短中期動能如何、有沒有站上均線。通過的才比較容易被挑進名單。",example:"某股今天比大盤強很多，又站上 SMA20／SMA50，就可能通過篩選 A。像短跑又比同學快、成績又在平均之上。"},screenB:{title:"篩選 B（量能）",plain:"檢查今天成交量是不是明顯比平常大（量比偏高）。量很大有時代表很多人注意，但也可能波動更大。",example:"量比 14 倍表示今天成交大約是平常的 14 倍。像學校平時很少人買某樣零食，今天突然大排長龍。"},screenC:{title:"篩選 C（估值）",plain:"想用本益比之類「貴不貴」的數字來幫忙選股。如果當天抓不到可靠資料，這個篩選就會跳過，避免亂填數字。",example:"本益比像「用幾年賺的錢才回本」的粗略尺。沒有尺就先不量，不要瞎猜。"},taiex:{title:"台灣加權（TAIEX）",plain:"把台灣上市很多股票的表現加總做成一個大分數，用來代表「台股整體」今天大概漲還是跌。",example:"加權今天 −0.77%，表示整體台股平均大概跌了一點點。像全校平均分數今天比昨天低一點。"},otc:{title:"櫃買",plain:"台灣「上櫃」公司的市場（比較多中小型公司）。櫃買指數用來看這群股票整體漲跌。",example:"上市像大學部大隊，櫃買像另一個年級隊。兩邊可以分開看今天誰比較強。"},spx:{title:"S&P 500",plain:"美國 500 家大型公司組成的指數，常被拿來代表「美股大盤」。",example:"S&P 500 跌 0.5%，常被說成美股大盤今天偏弱。像美國大型公司班級的平均分數。"},nasdaq:{title:"Nasdaq（那斯達克）",plain:"美國一個重要股市指數，裡面很多科技公司，常被用來觀察科技股整體氣氛。",example:"Nasdaq 大跌時，很多科技股也可能一起抖。像科技社社團活動特別熱絡或特別冷清的溫度計。"},sox:{title:"SOX（費半）",plain:"美國半導體（做晶片）公司的指數。半導體好不好，常常影響台積電供應鏈的氣氛。",example:"SOX 大跌，常常代表晶片相關股票今天整體承壓。像「晶片班」今天考試普遍不理想。"},usdtwd:{title:"USD/TWD（美金兌台幣）",plain:"1 美元可以換多少台幣。數字變大，常表示台幣變弱（同樣 1 美元換到更多台幣）；數字變小則相反。",example:"匯率 32，表示 1 美元約換 32 元台幣。你要買 10 美元零食，大約要付 320 元台幣。"},adr:{title:"ADR",plain:"美國存託憑證：讓投資人在美國市場買賣「外國公司」的股票憑證。例如台積電在美國有 TSM 這個 ADR。",example:"你在美國超市買「台灣零食的美國包裝版」。東西本質相近，但包裝市場不同，價錢也可能不太一樣。"},parity:{title:"平價／隱含價",plain:"用台股價格、換股比例和匯率，算出「如果完全公平換算，ADR 大概該是多少美元」。拿來跟實際 ADR 價比較。",example:"5 股台積電 ÷ 匯率，算出 ADR 理論價約 374 美元。像用匯率把台幣玩具價換算成美元標價。"},premium:{title:"溢價",plain:"實際市價比「換算後的理論價」還貴多少。正的溢價表示買 ADR 比照公式換算更貴；負的則比較便宜（折價）。",example:"理論 374 美元，市價 416 美元，溢價大約一成多。像同樣便當，車站賣得比學校社辦貴。"},adsRatio:{title:"換股比（ADS 比例）",plain:"一張 ADR 對應幾股本地普通股。台積電常見是 1 股 ADR＝5 股台灣普通股，但要以官方公告為準。",example:"比例 5:1 表示 1 個美國存託憑證背後約有 5 股台股。像 1 盒積木裡固定裝 5 小塊。"},limitUp:{title:"漲停",plain:"台股對一天最多能漲多少有限制（一般股票常見約 10%）。碰到上限就叫漲停，常常買不到或很難成交。",example:"股票從 100 元漲到約 110 元就可能漲停。像遊戲一天經驗值有上限，滿了就不能再加。"},momentum:{title:"動能",plain:"看價格最近是不是繼續往同一方向跑（例如連續幾天偏強）。這是數學觀察，不是保證明天還會這樣。",example:"球正在往前滾而且愈滾愈快，就說動能強。但滾到一半也可能停下或轉向。"},ticker:{title:"股票代碼（Ticker）",plain:"每支股票的簡短代號，方便電腦與市場辨認。美股多用英文字母，台股多用數字。",example:"AAPL 是蘋果，2330 是台積電。像學校學號，用來點名不會搞混。"},index:{title:"指數",plain:"把很多股票包成一個「總成績單」，用來代表某一市場或產業整體表現。",example:"加權指數、S&P 500 都是指數。像全班平均分數，不是某一個同學的分數。"},screening:{title:"數學選股／篩選",plain:"用事先講好的計算規則（漲跌、跟大盤比、均線、成交量等）自動挑出通過條件的股票，而不是靠感覺。",example:"規則：要比大盤強、量比要高。通過的進名單。像用尺量身高，過線的才能進籃球隊候補。"},notAdvice:{title:"不是投資建議",plain:"這個網站只是把公開行情算出來給你看。它不會保證賺錢，也不能代替你自己做決定。",example:"像天氣預報說可能下雨，你仍要自己決定要不要帶傘。看完數字也不等於一定要買。"},intraday:{title:"盤中",plain:"股市還在交易、價格還會一直變動的時候。跟「收盤」（今天交易結束後的最終價）不一樣。",example:"考試還沒結束，分數還可能改；收盤像交卷後的最終分數。"},twStock:{title:"台股",plain:"在台灣證券市場交易的股票，價錢多用新台幣計價。",example:"2330 台積電、2308 台達電都是台股。"},usStock:{title:"美股",plain:"在美國市場交易的股票，價錢多用美元計價。",example:"AAPL、NVDA、CRWD 都是美股。"},paperTrade:{title:"模擬交易",plain:"累積模擬帳戶：自 2026-09-15 起用 latest.json 標的價假設下單即成交，帳本不會每日歸零。非真實券商委託。",example:"像用假錢玩大富翁：規則跟算分是真的，但口袋裡的零用錢沒有真的拿去買股票。"},principal:{title:"本金",plain:"該市場模擬帳的起始資金。台股帳 NT$3,000,000；美股帳 US$100,000（兩帳獨立，不相加）。",example:"你帶 100 元去福利社，這 100 元就是本金。後來錢包變 90 或 120，都還是從這筆本金算起。"},position:{title:"部位",plain:"現在帳本裡「持有多少股票」。部位市值＝股數 × 現在價格。再加上現金，就是這本帳的權益。",example:"買了 1000 股、一股市價 50 元，部位大約 5 萬元。像背包裡現在裝了幾包零食、值多少錢。"},stopLoss:{title:"停損",plain:"事先講好：如果這筆模擬持有虧到某個百分比，就全部賣掉，避免虧更多。本站規則是未實現大約 −3%。",example:"遊戲裡血量低於 3 格就先撤退，不要硬打到歸零。這是保護本金的數學規則，不是保證以後不會虧。"},takeProfit:{title:"停利",plain:"事先講好：如果這筆模擬持有賺到某個百分比，就先賣一部分（本站大約 +12% 賣一半），把部分獲利放進現金。",example:"考試進步很多時，先把一部分分數「存起來」。不是說後面一定會跌，只是規則到點就減碼。"},unrealizedPnl:{title:"未實現損益",plain:"股票還沒賣掉時，用現在市價跟平均成本比，算出「帳面上」賺或虧多少。還沒賣掉就不算真正進口袋。",example:"你的遊戲卡市價變貴了，但你還沒賣掉，只是帳面變有錢。真的換成現金才算已實現。"},realizedPnl:{title:"已實現損益",plain:"真的（在模擬裡）賣掉以後，成交價減平均成本，已經記入現金的賺或虧。",example:"把遊戲卡賣掉拿到錢，這筆差額才算已實現。像把零食賣掉，錢已經回到錢包。"},periodPerf:{title:"週／月／季／年績效",plain:"看權益曲線最近一週、約一個月、約一季、約一年漲跌多少。若模擬開張還沒那麼久，就改看「從成立日到現在」。",example:"帳本才成立 1 天，還沒有「一年成績」，就寫成立以來。像學期才開學，先看開學到今天，不要假裝有全年成績。"},sinceInception:{title:"成立以來",plain:"從這本模擬帳開始的那一天算到現在。當歷史不夠一週／月／季／年時，就用這個標籤，避免假裝有更長的成績。",example:"新開的存摺沒有「去年」可以比，就說開戶以來。成績單太短時要老實講。"},danmaku:{title:"彈幕",plain:"像影片上飛過去的短句子。大家可以打很短的話，從螢幕右邊飛到左邊，讓氣氛熱鬧一點。",example:"有人打「今天量比好高！」就會變成一行字飛過畫面。跟下面慢慢看的留言板不一樣，彈幕偏短、偏即時。"},comments:{title:"留言板",plain:"掛在某一支股票卡片下面的討論區。大家可以針對這支股票慢慢寫想法，字數比彈幕多一點。",example:"在 CRWD 卡片下寫「量很大但要注意風險」，之後別人還看得到。像便利貼貼在該股票旁邊。"},reddit:{title:"Reddit",plain:"一個很大的英文網路論壇，裡面有很多討論區（subreddit）。本站只讀公開搜尋結果當「氣氛參考」，不會假裝有留言。",example:"r/stocks、r/wallstreetbets 常有人討論美股。如果網站抓不到（例如被 403 擋住），會老實寫 blocker，而不是編造。"},futu:{title:"富途牛牛",plain:"一款股票 App／平台（也叫 Moomoo）。本站目前多半只能拿到公開新聞搜尋，個股社群評論通常要登入，所以會標明「非社群評論」。",example:"看到「相關公開新聞」區塊，那是新聞標題，不是牛牛圈裡網友的真實留言。"},ptt:{title:"PTT",plain:"台灣很有名的論壇（批踢踢）。本站會搜尋 Stock 看板的公開文章標題當參考。",example:"在 Stock 板搜尋「2330」可能看到營收或標的文。看得到標題與連結，不代表我們同意裡面的看法。"},dcard:{title:"Dcard",plain:"台灣年輕人常用的匿名論壇 App／網站。本站試著搜尋股票相關討論；若被反爬擋住，會老實寫 blocker。",example:"有時 API 回 403，網站就會說「抓不到」，而不是自己編假留言。"},threads:{title:"Threads",plain:"Meta 的短文社群（跟 Instagram 有關）。沒有穩定的公開匿名搜尋 API 時，本站不會假裝有貼文。",example:"如果摘要寫「需登入／SPA」，代表公開抓取失敗，請改看其他來源或本站留言。"},pe:{title:"本益比（PE）",plain:"股價 ÷ 每股盈餘。數字愈小，用「現在賺的錢」來看，股價相對愈不貴（但還要看成長與風險）。沒抓到真實數字就不填。",example:"股價 100 元、一年每股賺 10 元，本益比約 10。像用 10 年賺的錢才回本的粗略尺。"},opMargin:{title:"營益率",plain:"營業利益 ÷ 營收。看「本業做生意」到底賺多少比例，還沒算業外投資。",example:"賣飲料營收 100 元，本業成本後剩 20 元，營益率約 20%。"},grossMargin:{title:"毛利率",plain:"毛利 ÷ 營收。只扣掉進貨／製造成本，還沒扣薪水、租金等營業費用。",example:"進貨 60 元、賣 100 元，毛利 40 元，毛利率 40%。"},foreignInv:{title:"外資",plain:"外國投資機構在台股買賣的總稱。公開資料會公布他們當天買超或賣超多少股。",example:"外資買超 100 萬股，表示外國機構今天淨買進約 100 萬股（≈ 1,000 張）。"},trustInv:{title:"投信",plain:"證券投資信託公司（基金公司）在台股的買賣。常被拿來看「法人」態度。",example:"投信買超代表基金們今天淨買比較多。"},dealerInv:{title:"自營商",plain:"券商用自己的錢買賣股票的部門。三大法人通常指外資＋投信＋自營商。",example:"自營商買超，表示券商自營部門今天淨買。"},maBull:{title:"均線多頭排列",plain:"短均線在長均線上面一層層排好（例如 SMA5>SMA10>SMA20>SMA60），常被看成短中期偏多的技術型態。",example:"像跑步成績：最近 5 天平均比 10 天好、又比 20／60 天好，節奏往上。"},rsi:{title:"RSI",plain:"相對強弱指標，常用 0–100。太高可能短線過熱，太低可能超賣；本站超短線策略看「在 50 以下且往上拐」。",example:"RSI 從 35 升到 42，還在 50 下，像體力表開始回升但還沒過半。"},amplitude:{title:"振幅",plain:"當天最高價與最低價差多少，再除以昨天收盤價。振幅大表示今天價格晃得兇。",example:"昨收 100，今天最高 104、最低 99，振幅約 5%。"},zhang:{title:"張",plain:"台股交易單位：1 張＝1,000 股。看成交量或法人買賣超時，常把「股」換算成「張」比較好讀。",example:"成交 300,000 股＝300 張。本站流動性門檻常寫「>300 張」。"},strategyScreen:{title:"策略選股（邏輯條件）",plain:"像選股軟體一樣：先選一套策略，看清楚每一條條件，再列出今天通過的股票與計算欄位。",example:"選「均線多頭排列」→ 看到 SMA 與量比條件 → 下面出現命中清單。"},xqLike:{title:"XQ／選股軟體風格",plain:"介面模仿常見台股看盤軟體的「策略分類＋條件＋命中數」操作習慣，方便對照；資料來源仍是公開行情，不是對方專有資料庫。",example:"左側點策略、中間看條件、下面看結果——流程很像，數字各自用公開資料算。"},socialDigest:{title:"網友參考（社交摘要）",plain:"把 Reddit、富途等公開來源整理成一天的小摘要給你看氣氛。它不是精準民調，更不是叫你買或賣。",example:"像把走廊上聽到的聊天重點寫在黑板上：有聽到就寫，沒聽到就老实说「今天抓不到」。"}};function r(e,t){const a=mt[e],i=t??(a==null?void 0:a.title)??e;return a?`<a class="term" href="#term-${c(e)}" data-term="${c(e)}">${c(i)}</a>`:c(i)}function c(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Tt(){return`
  ...
  `}function At(e){const t=e.querySelector("[data-glossary-list]");if(!t)return;const a=window.matchMedia("(min-width: 900px)"),i=()=>{t.querySelectorAll("details.glossary-item").forEach(s=>{a.matches?s.open=!0:s.classList.contains("flash")||(s.open=!1)})};i(),typeof a.addEventListener=="function"?a.addEventListener("change",i):typeof a.addListener=="function"&&a.addListener(i)}function qt(e,t={}){e.querySelectorAll("a.term").forEach(a=>{a.addEventListener("click",i=>{const s=a.getAttribute("data-term");i.preventDefault(),typeof t.beforeScroll=="function"&&t.beforeScroll(s);const l=()=>{const n=document.getElementById(`term-${s}`);n&&(n.tagName==="DETAILS"&&(n.open=!0),n.scrollIntoView({behavior:"smooth",block:"start"}),n.classList.add("flash"),setTimeout(()=>n.classList.remove("flash"),1600))};typeof t.beforeScroll=="function"?requestAnimationFrame(()=>requestAnimationFrame(l)):l()})})}const Pt="./data/paper-portfolio.json";function E(e){return e==null||Number.isNaN(e)?"flat":e>0?"up":e<0?"down":"flat"}function _(e,t=2){return e==null||Number.isNaN(e)?"—":`${e>0?"+":""}${e.toFixed(t)}%`}function ht(e,t=2){return e==null||Number.isNaN(e)?"—":Number(e).toLocaleString("zh-TW",{minimumFractionDigits:t,maximumFractionDigits:t})}function vt(e){return e==="USD"?"US$":e==="TWD"?"NT$":""}function D(e,t){if(e==null||Number.isNaN(e))return"—";const a=t==="TWD"?0:2;return`${vt(t)}${ht(e,a)}`}function W(e,t){if(e==null||Number.isNaN(e))return"—";const a=t==="TWD"&&e>=100?0:2;return`${vt(t)}${ht(e,a)}`}function ft(e){return{"screen-buy":"名單新開倉",add:"持續買進",stop:"停損","take-profit":"停利","momentum-break":"動能轉弱","off-list":"離開名單","limit-up-chase":"漲停追價急殺"}[e]||e||""}function G(e){return e?`
    <div class="paper-win">
      ...
      </tr>`}).join(""):'<tr><td colspan="6" class="empty-cell">目前沒有持股</td></tr>'}function Nt(e,t,a){const i=t.currency,s=e==="TW"?`${r("twStock","台股")}帳本（NT$）`:`${r("usStock","美股")}帳本（US$）`,l=D(t.startCash,i),n=(a==null?void 0:a.totalPnl)??t.equity-t.startCash,u=(a==null?void 0:a.totalPnlPct)??(t.startCash?(t.equity-t.startCash)/t.startCash*100:0);return`
    ...
    </div>`}function at(e,t,a,i,s,l){const n=t.currency,u=[...t.trades||[]].sort((m,o)=>m.date<o.date?1:m.date>o.date?-1:0),h=u.filter(m=>m.date===i),d=h.filter(m=>m.side==="BUY"),b=h.filter(m=>m.side==="SELL"),g=u.slice(0,40),$=l;return`
    <div class="paper-panel ${s?"active":""}" id="paper-panel-${e}" role="tabpanel">
      ${Nt(e,t,a)}
      <p class="paper-session-note">${c(i||"—")} · 自 ${c($)} 累積 · 買進即成交</p>
      ${F(`買 ${i||""}`,d,n)}
      ${F(`賣 ${i||""}`,b,n)}
      ${Rt(t.positions||[],n)}
      ${F("成交（近 40）",g,n)}
    </div>`}function Et(e){var n,u;if(!e||!e.books)return`
    ...
    <section class="section paper-section" id="paper">
      ...
      <div class="ss-src-panels">
        ...
        ${o}
      </div>`;e.innerHTML=g?`<div class="ss-thread-bare" data-ticker="${S(t)}">${f}</div>`:`<details class="ss-thread-details"${$}>
      <summary>${S(t)}</summary>
      ${f}
    </details>`;const v=e.querySelector(".ss-thread-status"),k=e.querySelector(".ss-thread-list"),N=e.querySelector(".ss-thread-form"),O={ptt:["ptt","PTT",!1],dcard:["dcard","Dcard",!1],threads:["threads","Threads",!1],reddit:["reddit","Reddit",!1],futu:["futu","富途",!0]};for(const y of n){if(y.id==="local")continue;const q=O[y.id];if(!q)continue;const[L,M,Z]=q,et=e.querySelector(`[data-panel="${y.id}"]`);et&&(et.innerHTML=zt(Vt(s,L,t),M,{futuMode:Z}))}const U=e.querySelectorAll(".ss-src-tab"),V=e.querySelectorAll(".ss-src-panel");if(U.forEach(y=>{y.addEventListener("click",()=>{const q=y.dataset.src;U.forEach(L=>{const M=L.dataset.src===q;L.classList.toggle("active",M),L.setAttribute("aria-selected",M?"true":"false")}),V.forEach(L=>{const M=L.dataset.panel===q;L.classList.toggle("active",M),L.hidden=!M})})}),!u||!h)return v.textContent=Y,v.className="ss-thread-status is-warn",N.querySelectorAll("input,textarea,button").forEach(y=>{y.disabled=!0}),k.innerHTML='<li class="ss-empty">後端未接上</li>',{ok:!1,reason:"no-config",market:l};const H=$t(u,h);v.textContent="";let C=!1;async function w(){try{const y=await H.list(t);if(!y.length){k.innerHTML='<li class="ss-empty">尚無留言</li>';return}k.innerHTML=y.map(q=>`<li><strong>${S(q.nickname)}</strong> ${S(q.body)}<span class="meta">${S(new Date(q.created_at).toLocaleString("zh-TW",{hour12:!1}))}</span></li>`).join("")}catch(y){v.textContent=`讀取失敗：${y.message}`,v.className="ss-thread-status is-warn"}}N.addEventListener("submit",async y=>{if(y.preventDefault(),C)return;const q=(N.querySelector(".ss-nick").value||"訪客").trim().slice(0,24)||"訪客",L=(N.querySelector(".ss-body").value||"").trim().slice(0,d);if(!L)return;C=!0;const M=N.querySelector("button");M.disabled=!0;try{await H.insert({ticker:t,body:L,nickname:q}),N.querySelector(".ss-body").value="",await w()}catch(Z){v.textContent=`發送失敗：${Z.message}`,v.className="ss-thread-status is-warn"}finally{window.setTimeout(()=>{C=!1,M.disabled=!1},b)}}),w();const P=window.setInterval(w,i.pollIntervalMs||1e4);return{ok:!0,market:l,destroy(){window.clearInterval(P)}}}function it(e,t,a={}){if(!e||!t)return{ok:!1,destroy(){}};const i=a.config||globalThis.STOCK_SOCIAL_CONFIG||{},s=bt(t,a.market||e.getAttribute("data-market")),{url:l,anon:n}=gt(i),u=Math.min(i.commentMaxLen||500,a.maxLen||200),h=i.postCooldownMs||4e3,d=a.title||t,b=a.emptyLine||"尚無訊息",g=a.danmakuLayer||document.querySelector("#ss-danmaku-layer"),$=a.flyToggle||document.querySelector("#ss-danmaku-toggle"),m=()=>!!($&&$.checked);e.classList.add("chat-shell","ss-thread"),e.dataset.market=s,e.dataset.ticker=t,e.innerHTML=`
    <div class="chat-room-label">${S(d)}</div>
  ...
  `;const o=e.querySelector(".ss-thread-status"),f=e.querySelector(".ss-thread-list"),v=e.querySelector(".ss-thread-form");let k=new Set;function N(C){if(!g||!m())return;const w=document.createElement("div");w.className="ss-danmaku-item",w.textContent=C,w.style.top=`${8+Math.random()*42}vh`,w.style.animationDuration="12000ms",g.appendChild(w),window.setTimeout(()=>w.remove(),12200)}if(!l||!n)return o.textContent=Y,o.className="ss-thread-status chat-status-line is-warn",v.querySelectorAll("input,button").forEach(C=>{C.disabled=!0}),f.innerHTML=`<li class="ss-empty">${S(b)}</li>`,{ok:!1,reason:"no-config",market:s,destroy(){}};const O=$t(l,n);o.textContent="";let U=!1;async function V(C=!1){try{const w=await O.list(t,80);if(!w.length){f.innerHTML=`<li class="ss-empty">${S(b)}</li>`;return}f.innerHTML=w.map(P=>`<li><span class="nick">${S(P.nickname)}</span>${S(P.body)}<span class="meta">${S(new Date(P.created_at).toLocaleString("zh-TW",{hour12:!1}))}</span></li>`).join(""),f.scrollTop=f.scrollHeight;for(const P of w)k.has(P.id)||(k.add(P.id),C&&N(`${P.nickname}: ${P.body}`));k.size>200&&(k=new Set([...k].slice(-100)))}catch{o.textContent=Y,o.className="ss-thread-status chat-status-line is-warn"}}v.addEventListener("submit",async C=>{if(C.preventDefault(),U)return;const w=(v.querySelector(".ss-nick").value||"訪客").trim().slice(0,24)||"訪客",P=(v.querySelector(".ss-body").value||"").trim().slice(0,u);if(!P)return;U=!0;const y=v.querySelector("button");y.disabled=!0;try{await O.insert({ticker:t,body:P,nickname:w}),v.querySelector(".ss-body").value="",await V(!0)}catch{o.textContent="發送失敗",o.className="ss-thread-status chat-status-line is-warn"}finally{window.setTimeout(()=>{U=!1,y.disabled=!1},h)}}),V(!1);const H=window.setInterval(()=>V(!0),i.pollIntervalMs||8e3);return{ok:!0,market:s,ticker:t,destroy(){window.clearInterval(H)}}}function Ht(e=document,t={}){const a=e.querySelectorAll("[data-ticker-comments]"),i=[];return a.forEach(s=>{const l=s.getAttribute("data-ticker-comments")||s.dataset.ticker,n=s.getAttribute("data-market")||void 0;l&&i.push(Bt(s,l,{...t,market:n}))}),i}function Gt(e,t){if(!e||!t||e.querySelector("script[data-giscus], iframe.giscus-frame"))return;const a=document.createElement("script");a.src="https://giscus.app/client.js",a.async=!0,a.crossOrigin="anonymous",a.setAttribute("data-giscus","1"),a.setAttribute("data-repo",t.repo||""),a.setAttribute("data-repo-id",t.repoId||""),a.setAttribute("data-category",t.category||"General"),a.setAttribute("data-category-id",t.categoryId||""),a.setAttribute("data-mapping",t.mapping==="pathname"?"pathname":"specific"),a.setAttribute("data-term",t.term||"site-discussion"),a.setAttribute("data-strict","0"),a.setAttribute("data-reactions-enabled","1"),a.setAttribute("data-emit-metadata","0"),a.setAttribute("data-input-position","bottom"),a.setAttribute("data-theme",t.theme||"dark"),a.setAttribute("data-lang",t.lang||"zh-TW"),e.appendChild(a)}function _t(e="#ss-giscus",t={}){const a=document.querySelector(e);if(!a)return{ok:!1,reason:"missing"};const s=(t.config||globalThis.STOCK_SOCIAL_CONFIG||{}).giscus||{};if(!s.enabled||!s.repoId||!s.categoryId)return a.innerHTML='<p class="ss-chat-status is-warn">Giscus 尚未設定（需 repoId / categoryId）。請見 README。</p>',{ok:!1,reason:"no-config"};const l=a.querySelector(".ss-giscus-host")||a;return Gt(l,{...s,term:s.term||"site-discussion"}),{ok:!0}}function x(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Zt(e){const t=e.manualUrls||[];return t.length?'<p class="ss-digest-sub">手動開啟</p>'+t.slice(0,4).map(a=>`<article class="ss-digest-item"><a href="${x(a)}" target="_blank" rel="noopener noreferrer">${x(a)}</a></article>`).join(""):""}function lt(e){const t=e.score!=null?`<span class="ss-score">▲ ${x(e.score)}</span>`:"",a=e.author?`@${x(e.author)}`:"",i=e.created?x(new Date(e.created).toLocaleString("zh-TW",{hour12:!1})):e.date?x(e.date):"",s=e.via?`<span class="ss-via">${x(e.via)}</span>`:"";return`<article class="ss-digest-item">
    <a href="${e.url?x(e.url):"#"}" target="_blank" rel="noopener noreferrer">${x(e.snippet||e.title||"(無摘要)")}</a>
    <div class="ss-digest-meta">${t} ${a} ${i} ${s}</div>
  </article>`}function Ft(e,t,{futuMode:a=!1}={}){var h;const i=e.blocker?`<p class="ss-digest-blocker">⚠ ${x(e.blocker)}</p>`:"",s=e.items||[],l=e.newsRelated||[];let n="";s.length&&(n+=s.map(lt).join("")),l.length&&(n+=`<p class="ss-digest-sub">${a?"新聞／討論線索（非留言）":"相關公開新聞（非社群評論）"}</p>`+l.map(lt).join("")),!s.length&&((h=e.manualUrls)!=null&&h.length)&&(n+=Zt(e)),n||(n=`<p class="ss-empty">此標的暫無${x(t)}資料</p>`);const u=e.via&&e.via!=="reddit.com"?`<p class="ss-digest-via-note">來源備援：${x(e.via)}</p>`:"";return`<section class="ss-digest-ticker" data-ticker="${x(e.ticker)}">
    <h4>${x(e.ticker)}</h4>
    ${i}
    ${u}
    ${n}
  </section>`}function z(e,t,a,i={}){const s=(t||[]).map(l=>Ft(l,a,i)).join("");return`<div class="ss-digest-col">
    <h4 class="ss-digest-col-title">${x(e)}</h4>
    ${s||`<p class="ss-empty">無 ${x(e)} 區塊（今日無對應市場標的或尚未抓取）</p>`}
  </div>`}async function yt(e){const t=globalThis.STOCK_SOCIAL_CONFIG||{},a=e||t.socialDigestUrl||"./data/social-digest.json",i=await fetch(a,{cache:"no-cache"});if(!i.ok)throw new Error(`social-digest ${i.status}`);return i.json()}function Jt(e,t){if(!t)return;const a=e.asOf?new Date(e.asOf).toLocaleString("zh-TW",{hour12:!1}):"—";(e.notes||[]).map(d=>`<li>${x(d)}</li>`).join(""),e.routing;const i=`
    ...
    </div>`,l=(e.reddit||[]).length||(e.futu||[]).length,n=(e.ptt||[]).length||(e.dcard||[]).length||(e.threads||[]).length,u=l?"US":n?"TW":"US";t.innerHTML=`
    <div class="ss-digest">
    ...
    <div class="xq-market-block" data-market="${c(t)}">
      ...
      <div class="table-wrap xq-table-wrap">
        <table class="stock-table xq-table">
          <thead><tr><th>代碼</th><th>名稱</th>${n}</tr></thead>
          <tbody>${u}</tbody>
        </table>
      </div>
      <div class="xq-mobile-cards">${h}</div>
    </div>`}function rt(e,t,a="TW"){var d,b;const i=e.hits||[],l=St(i,a).length,n=(e.unchecked||[]).map(g=>`<li class="xq-unchecked">${c(g)}</li>`).join(""),u=(e.notes||[]).map(g=>`<li>${c(g)}</li>`).join(""),h=!e.incomplete&&(e.blockers||[]).length?`<ul class="xq-blockers">${(e.blockers||[]).map(g=>`<li>${c(g)}</li>`).join("")}</ul>`:"";return`
  ...
  `}async function re(e=kt){const t=await fetch(e,{cache:"no-cache"});if(!t.ok)throw new Error(`strategy-screener ${t.status}`);return t.json()}function ne(e,t){var m;const a=typeof e=="string"?document.querySelector(e):e;if(!a||!((m=t==null?void 0:t.strategies)!=null&&m.length)){a&&(a.innerHTML='<div class="xq-empty"><p>尚無策略資料。請執行 <code>npm run strategies</code>。</p></div>');return}const i=t.categoryOrder||["精選","價量","籌碼","財務","大師"],s=new Map(i.map(o=>[o,[]]));for(const o of t.strategies){const f=Qt(o);s.has(f)||s.set(f,[]),s.get(f).push(o)}const l=t.strategies[0];let n="TW";const u=i.map(o=>{const f=s.get(o)||[];return f.length?`<div class="xq-cat-block">
      ...
      </div>`:""}).join(""),h=t.strategies.map(o=>{const f=(o.hits||[]).length,v=o.id===l.id?" active":"",k=o.incomplete?" incomplete":"";return`<button type="button" class="xq-side-item${v}${k}" data-xq-id="${c(o.id)}">
        <span>${c(o.name)}</span>
        <span class="xq-side-n">${o.incomplete?"不足":`共${f}檔`}</span>
  ...
  `;const d=a.querySelector(".xq-panel-host");let b=l.id;const g=()=>{de(d,t),d==null||d.querySelectorAll("[data-xq-market]").forEach(o=>{o.addEventListener("click",()=>{n=o.getAttribute("data-xq-market")||"TW",$(b)})}),d==null||d.querySelectorAll("a.term").forEach(o=>{o.addEventListener("click",f=>{const v=o.getAttribute("data-term"),k=document.getElementById(`term-${v}`);k&&(f.preventDefault(),k.tagName==="DETAILS"&&(k.open=!0),k.scrollIntoView({behavior:"smooth",block:"start"}),k.classList.add("flash"),setTimeout(()=>k.classList.remove("flash"),1600))})})},$=o=>{const f=t.strategies.find(v=>v.id===o);!f||!d||(b=o,d.innerHTML=rt(f,t,n),a.querySelectorAll("[data-xq-id]").forEach(v=>{const k=v.getAttribute("data-xq-id")===o;v.classList.toggle("active",k),v.tagName==="BUTTON"&&v.setAttribute("aria-pressed",k?"true":"false")}),g())};a.querySelectorAll("[data-xq-id]").forEach(o=>{o.addEventListener("click",()=>$(o.getAttribute("data-xq-id")))}),g()}function ce(e){const t=e.hits||[];if(!t.length)return"";const a=[...new Set(t.flatMap(n=>Object.keys(n.metrics||{})))],i=["ticker","name","market","ohlcvBarDate",...a],s=n=>{const u=n==null?"":String(n);return/[",\n]/.test(u)?`"${u.replace(/"/g,'""')}"`:u},l=t.map(n=>{const u=n.metrics||{};return[n.ticker,n.name,n.market,n.ohlcvBarDate||"",...a.map(h=>u[h])].map(s).join(",")});return[i.join(","),...l].join(`
`)}function oe(e,t,a){const i=new Blob([t],{type:a}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=e,s.click(),setTimeout(()=>URL.revokeObjectURL(s.href),2e3)}function de(e,t){var a,i;(a=e==null?void 0:e.querySelector("[data-xq-copy]"))==null||a.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(JSON.stringify(t,null,2));const s=e.querySelector("[data-xq-copy]");if(s){const l=s.textContent;s.textContent="已複製",setTimeout(()=>s.textContent=l,1200)}}catch{}}),(i=e==null?void 0:e.querySelector("[data-xq-csv]"))==null||i.addEventListener("click",()=>{var u;const s=(u=e.querySelector(".xq-panel"))==null?void 0:u.getAttribute("data-strategy-id"),l=t.strategies.find(h=>h.id===s);if(!l)return;const n=ce(l);if(!n){alert("此策略今日無命中列可匯出");return}oe(`${l.id}-hits.csv`,"\uFEFF"+n,"text/csv;charset=utf-8")})}async function pe(e="#xq-root"){try{const t=await re();return ne(e,t),{ok:!0,data:t}}catch(t){const a=document.querySelector(e);return a&&(a.innerHTML=`<div class="xq-empty"><p>無法載入策略選股（${c(t.message)}）。請確認已執行 <code>npm run strategies</code>。</p></div>`),{ok:!1,error:t}}}const ue="./data/latest.json";function A(e){return e==null||Number.isNaN(e)?"flat":e>0?"up":e<0?"down":"flat"}function T(e,t=2){return e==null||Number.isNaN(e)?"—":`${e>0?"+":""}${e.toFixed(t)}%`}function I(e,t=2){return e==null||Number.isNaN(e)?"—":Number(e).toLocaleString("zh-TW",{minimumFractionDigits:t,maximumFractionDigits:t})}function B(e,t){if(e==null||Number.isNaN(e))return"—";const a=t==="TWD"&&e>=100?0:2;return`${t==="USD"?"$":t==="TWD"?"NT$":""}${I(e,a)}`}function me(e){try{return new Date(e).toLocaleString("zh-TW",{timeZone:"Asia/Taipei",year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})+"（台北）"}catch{return e}}function Q(e){const t=e.aboveSma20?`<span class="badge sma-on">${r("sma20","SMA20↑")}</span>`:`<span class="badge sma-off">${r("sma20","SMA20↓")}</span>`,a=e.aboveSma50?`<span class="badge sma-on">${r("sma50","SMA50↑")}</span>`:`<span class="badge sma-off">${r("sma50","SMA50↓")}</span>`;return t+a}function tt(e){return e!=null&&e.length?e.map(t=>{const a=String(t);return a==="A"?`<span class="badge screen">${r("screenA","A")}</span>`:a==="B"?`<span class="badge screen">${r("screenB","B")}</span>`:a==="C"?`<span class="badge screen">${r("screenC","C")}</span>`:a==="observe"?'<span class="badge screen">觀察</span>':`<span class="badge screen">${c(a)}</span>`}).join(""):""}function he(e){var i,s,l,n,u;const t=[],a=(h,d,b)=>{if(!b)return;const g=b.incomplete,$=b.value!=null?I(b.value,2):g?"資料不全":"—",m=b.dayPct!=null?`<div class="pct ${A(b.dayPct)}">${T(b.dayPct)}</div>`:"",o=b.session==="intraday"?` · ${r("intraday","盤中")}`:"";t.push(`
      <div class="index-chip ${g?"incomplete":""}">
        <div class="label">${d}${o}</div>
        <div class="value">${$}</div>
        ${m}
      </div>
    `)};if(a("tw",r("taiex",((i=e.tw)==null?void 0:i.name)||"台灣加權 TAIEX"),e.tw),a("otc",r("otc",((s=e.otc)==null?void 0:s.name)||"櫃買"),e.otc),a("spx",r("spx",((l=e.spx)==null?void 0:l.name)||"S&P 500"),e.spx),a("nasdaq",r("nasdaq",((n=e.nasdaq)==null?void 0:n.name)||"Nasdaq"),e.nasdaq),a("sox",r("sox",((u=e.sox)==null?void 0:u.name)||"SOX"),e.sox),e.usdTwd){const h=e.usdTwd,d=h.taipeiClose??h.yahoo;t.push(`
  ...
  `}function xt(e){let t=c(e);return t=t.replace(/漲停/g,r("limitUp","漲停")),t=t.replace(/動能/g,r("momentum","動能")),t}function nt(e){return e.map(t=>{const a=t.rsVsIndexPp??t.priorClosePct,i=t.rsVsIndexPp!=null?T(t.rsVsIndexPp):t.priorClosePct!=null?T(t.priorClosePct):"—";return`
      <tr>
      ...
      </div>`}).join("")}function fe(e){if(!e)return"";const t=e.premiumPct;return`
  ...
  `}function be(e){if(!e)return"";const t={A:"screenA",B:"screenB",C:"screenC"},a=Object.keys(e).map(i=>{const s=t[i]||"screening";return`<li><span class="screen-key">${r(s,i)}</span><span>${c(e[i])}</span></li>`}).join("");return`
  ...
  `}function $e(){return'<div id="ss-danmaku-layer" class="ss-danmaku-layer" aria-hidden="true"></div>'}function X(e){return e?e.market==="TW"||e.market==="US"?e.market:String(e.ticker||"").toUpperCase().endsWith(".TW")?"TW":"US":"US"}function ot(e,t){const a=new Set,i=[],s=l=>{if(!(l!=null&&l.ticker)||a.has(l.ticker))return;const n=X(l);t&&n!==t||(a.add(l.ticker),i.push({ticker:l.ticker,market:n,name:l.name||""}))};return(e.top5||[]).forEach(s),(!t||t==="TW")&&(e.tw||[]).forEach(s),(!t||t==="US")&&(e.us||[]).forEach(s),i}function ye(e){return e==="TW"?"__TW__":"__US__"}function dt(e,t){return e.length?`<div class="top5-grid">${e.map((a,i)=>ve(a,i+1)).join("")}</div>`:`<div class="empty-state">${c(t)} Top 尚無</div>`}function ke(e){const t=ot(e,"US"),a=ot(e,"TW"),i=(s,l)=>s.map((n,u)=>`<button type="button" class="chat-chip${u===0?" active":""}" data-ticker="${c(n.ticker)}" data-market="${l}" hidden>${c(n.ticker)}</button>`).join("");return`
  ...
  `}const Se=[{id:"today",label:"今日",hash:"today"},{id:"strategies",label:"策略",hash:"strategies"},{id:"paper",label:"模擬",hash:"paper"},{id:"social",label:"社群",hash:"social"},{id:"help",label:"說明",hash:"help"}],wt={today:"today",strategies:"strategies",paper:"paper",social:"social",help:"help",glossary:"help",danmaku:"social","social-digest":"social",giscus:"social",method:"help"},xe={today:'<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M7 2h2v2h6V2h2v2h3a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3V2zm12 8H5v10h14V10zm-2-5H7v2h10V5z"/></svg>',strategies:'<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M4 19h16v2H4v-2zm2.5-3.5 4-4 3 3L21 6.5 19.5 5l-6 7.5-3-3L4 14.5l2.5 1z"/></svg>',paper:'<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 14.93V17h-2v-.07A8.01 8.01 0 0 1 5.07 13H7v-2H5.07A8.01 8.01 0 0 1 11 5.07V7h2V5.07A8.01 8.01 0 0 1 18.93 11H17v2h1.93A8.01 8.01 0 0 1 13 16.93z"/></svg>',social:'<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 3C7 3 3 6.6 3 11c0 2.4 1.2 4.5 3.1 6L5 21l4.3-1.4c.9.3 1.8.4 2.7.4 5 0 9-3.6 9-8s-4-8-9-8zm-1 5h2v5h-2V8zm0 6h2v2h-2v-2z"/></svg>',help:'<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2a10 10 0 1 0 .001 20.001A10 10 0 0 0 12 2zm0 15a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zm1.6-5.35c-.55.35-.85.6-.95 1.1l-.1.75h-1.5l.12-.95c.15-.95.7-1.5 1.4-1.95.55-.35.9-.6.9-1.15 0-.55-.45-.95-1.15-.95-.75 0-1.2.4-1.35 1.05l-1.45-.35C9.75 8.2 10.7 7.2 12.2 7.2c1.65 0 2.85 1 2.85 2.4 0 .85-.45 1.5-1.45 2.05z"/></svg>'};function pt(){const e=(location.hash||"").replace(/^#/,"").split(/[/?]/)[0].toLowerCase();return wt[e]||"today"}function ut(e){return Se.map(t=>{const a=xe[t.id]||"";return`
      ...
      </button>`}).join("")}function we(e,t){const a=e.top5||[],i=e.us||[],s=e.tw||[],l=c((e.disclaimer||"本站內容非投資建議。").replace(/^本站內容為依公開行情的數學篩選候選，不是投資建議，亦不保證獲利。$/,"本站只是用公開行情算出「相對有機會觀察的名單」，不會保證賺錢。"));return`
    ${$e()}
    ...
    <header class="site-chrome">
      <div class="chrome-brand">
        ...
        <div class="brand-text">
          ...
          <p class="brand-meta">資料 ${me(e.asOf)}</p>
        </div>
      </div>
  ...
  `}function Te(e,t){e.querySelectorAll(".nav-item").forEach(a=>{const i=a.dataset.nav===t;a.classList.toggle("is-active",i),a.setAttribute("aria-current",i?"page":"false")})}function Ae(e,t,{updateHash:a=!0,scrollTop:i=!0}={}){const s=wt[t]||"today";if(e.querySelectorAll(".view").forEach(l=>{const n=l.dataset.view===s;l.hidden=!n,l.classList.toggle("is-active",n)}),Te(e,s),a){const l=`#${s}`;location.hash!==l&&history.replaceState(null,"",l)}return i&&window.scrollTo(0,0),s}function qe(e){const t=(a,i)=>Ae(e,a,i);return e.querySelectorAll(".nav-item").forEach(a=>{a.addEventListener("click",()=>t(a.dataset.nav))}),e.querySelectorAll("[data-jump]").forEach(a=>{a.addEventListener("click",()=>t(a.dataset.jump))}),window.addEventListener("hashchange",()=>{t(pt(),{updateHash:!1})}),t(pt(),{updateHash:!0,scrollTop:!1}),{go:t}}function Pe(e){const t=e.querySelectorAll(".tab-btn");t.forEach(a=>{a.addEventListener("click",()=>{const i=a.dataset.tab;t.forEach(s=>{const l=s.dataset.tab===i;s.classList.toggle("active",l),s.setAttribute("aria-selected",l?"true":"false")}),e.querySelectorAll(".panel").forEach(s=>{s.classList.toggle("active",s.id===`panel-${i}`)})})})}function Le(e,t,{config:a,digest:i}={}){const s=e.querySelector("#chat-room");if(!s)return;const l=s.querySelector("#ss-chat-mount"),n=s.querySelectorAll(".chat-mkt"),u=s.querySelectorAll("[data-chat-mode]");let h=null,d="US",b="lobby";const g=()=>{s.querySelectorAll(".chat-chip-row").forEach(m=>{const o=b==="ticker"&&m.getAttribute("data-chip-market")===d;if(m.hidden=!o,o){const f=[...m.querySelectorAll(".chat-chip")];f.forEach(v=>{v.hidden=!1}),f.length&&!f.some(v=>v.classList.contains("active"))&&f[0].classList.add("active")}})},$=()=>{if(!l)return;if(h!=null&&h.destroy&&h.destroy(),b==="lobby"){const f=ye(d);h=it(l,f,{config:a,market:d,title:d==="TW"?"台股大廳":"美股大廳",emptyLine:"尚無訊息",maxLen:80});return}const m=s.querySelector(`.chat-chip-row[data-chip-market="${d}"]`),o=(m==null?void 0:m.querySelector(".chat-chip.active"))||(m==null?void 0:m.querySelector(".chat-chip"));if(!o){l.innerHTML='<p class="chat-empty">此市場暫無標的</p>',h={destroy(){}};return}h=it(l,o.dataset.ticker,{config:a,market:d,title:o.dataset.ticker,emptyLine:"尚無留言"})};n.forEach(m=>{m.addEventListener("click",()=>{d=m.dataset.chatMarket,s.dataset.market=d,n.forEach(f=>{const v=f===m;f.classList.toggle("active",v),f.setAttribute("aria-selected",v?"true":"false")});const o=s.querySelector(`.chat-chip-row[data-chip-market="${d}"]`);o==null||o.querySelectorAll(".chat-chip").forEach((f,v)=>f.classList.toggle("active",v===0)),g(),$()})}),u.forEach(m=>{m.addEventListener("click",()=>{b=m.dataset.chatMode,s.dataset.mode=b,u.forEach(o=>{const f=o===m;o.classList.toggle("active",f),o.setAttribute("aria-selected",f?"true":"false")}),g(),$()})}),s.querySelectorAll(".chat-chip").forEach(m=>{m.addEventListener("click",()=>{const o=m.closest(".chat-chip-row");o==null||o.querySelectorAll(".chat-chip").forEach(f=>f.classList.toggle("active",f===m)),b==="ticker"&&$()})}),g(),$()}async function Ce(){const e=document.getElementById("app");try{const t=await fetch(ue);if(!t.ok)throw new Error(`HTTP ${t.status}`);const a=await t.json(),i=await jt();e.innerHTML=we(a,i);const s=qe(e);Pe(e),Ut(e),At(e),qt(e,{beforeScroll(){s.go("help",{updateHash:!0,scrollTop:!1})}}),await pe("#xq-root");let l=null;const n=await Kt("#ss-social-digest",R.socialDigestUrl);if(n!=null&&n.ok)l=n.data;else try{l=await yt(R.socialDigestUrl)}catch{l=null}Le(e,a,{config:R,digest:l}),Ht(e,{config:R,digest:l}),_t("#ss-giscus",{config:R})}catch(t){e.innerHTML=`<div class="error">無法載入資料（${c(t.message)}）。請確認以靜態伺服器開啟，且 data/latest.json 存在。</div>`}}Ce();
